---
name: humanizer
description: A 3D character creation system based on MakeHuman and MPFB2, allowing procedural generation of humanoid characters with extensive customization opt...
