---
name: godot-3d-architecture
description: Complete guide to structuring and architecting Godot 4.x 3D projects — scene composition, state machines, components, EventBus, physics, navigation, and performance patterns derived from official demo projects.
license: MIT
compatibility: Godot 4.x, Feudal Game project
metadata:
  source: "Official Godot demo projects (godotengine/godot-demo-projects/3d/)"
  date: "2025-04-30"
  scope: "3D architecture, project structure, performance"
tags:
  - godot
  - 3d
  - architecture
...
## 13. Related Research Reports

The following research reports in `docs/research/` provide additional context and should be consulted when architecting specific systems:
