...
description: A node-based behavior tree implementation for Godot, allowing visual AI behavior design within the scene tree with dedicated debugging tools.
license: MIT (assumed)
