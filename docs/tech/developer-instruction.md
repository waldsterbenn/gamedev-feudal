...
*   **Terrain3D**: High-performance, GDExtension-based terrain system for large-scale environments. [Skill Documentation](/docs/skills/terrain3d/SKILL.md)
*   **HTerrain (Legacy)**: High-performance heightmap terrain system. [Legacy Skill Documentation](/docs/skills/hterrain/SKILL.md) (Note: Project is migrating to Terrain3D)
